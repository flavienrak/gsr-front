  ...
  return (
    <>
      <div className=" w-1/5  flex flex-col items-center gap-4 ">
        <div className=" w-full flex items-center gap-4 px-4 py-6 bg-[var(--white)] rounded-xl ">
          ...
          <div className=" flex flex-col ">
            <p>Lionel Socrate</p>
            <p className=" text-[var(--gray-text)] ">lionel@gmail.com</p>
          </div>
        </div>
        <div className=" w-full  h-full bg-[var(--white)]  rounded-xl overflow-hidden ">
